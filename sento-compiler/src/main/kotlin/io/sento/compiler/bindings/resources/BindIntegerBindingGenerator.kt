...
internal class BindIntegerBindingGenerator : FieldBindingGenerator<BindInteger> {
  override fun bind(context: FieldBindingContext<BindInteger>, environment: GenerationEnvironment) {
